...
final class CabinetController extends AbstractController
{
    ...
    #[Route('/{id}', name: 'app_psy_cabinet_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_psy_cabinet_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_psy_cabinet_delete', methods: ['POST'])]
    ...
    #[Route('/{id}/valider', name: 'app_psy_cabinet_validate', methods: ['POST'])]
    ...
    #[Route('/{id}/archiver', name: 'app_psy_cabinet_archive', methods: ['POST'])]
    ...
    #[Route('/disponibilites/{id}/edit', name: 'app_psy_disponibilite_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/disponibilites/{id}', name: 'app_psy_disponibilite_delete', methods: ['POST'])]
