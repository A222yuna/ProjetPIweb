...
final class CabinetController extends AbstractController
{
    ...
    #[Route('/{id}/valider', name: 'app_cabinet_validate', methods: ['POST'])]
    ...
    #[Route('/{id}/archiver', name: 'app_cabinet_archive', methods: ['POST'])]
    ...
    #[Route('/disponibilites/{id}/edit', name: 'app_disponibilite_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/disponibilites/{id}', name: 'app_disponibilite_delete', methods: ['POST'])]
