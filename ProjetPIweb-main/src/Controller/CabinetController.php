...
final class CabinetController extends AbstractController
{
    ...
    public function index(CabinetRepository $cabinetRepository): Response
    {
        return $this->render('cabinet/index.html.twig', [
            ...
            'cabinet_route_prefix' => 'app_cabinet_',
            'disponibilite_route_prefix' => 'app_disponibilite_',
        ]);
    }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_cabinet_index');
        }

        return $this->render('cabinet/new.html.twig', [
            'cabinet' => $cabinet,
            'form' => $form,
            'index_route' => 'app_cabinet_index',
        ]);
    }

    #[Route('/{id}', name: 'app_cabinet_show', requirements: ['id' => '\d+'], methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_cabinet_edit', requirements: ['id' => '\d+'], methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_cabinet_delete', requirements: ['id' => '\d+'], methods: ['POST'])]
    ...
    #[Route('/{id}/valider', name: 'app_cabinet_validate', requirements: ['id' => '\d+'], methods: ['POST'])]
    public function validateCabinet(Request $request, Cabinet $cabinet, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('validate_cabinet_'.$cabinet->getId(), (string) $request->request->get('_token'))) {
            $cabinet->setValide(true);
            $entityManager->flush();
            $this->addFlash('success', 'Cabinet valide.');
        } else {
            $this->addFlash('error', 'Jeton CSRF invalide.');
        }
    ...
    #[Route('/{id}/archiver', name: 'app_cabinet_archive', requirements: ['id' => '\d+'], methods: ['POST'])]
    public function archive(Request $request, Cabinet $cabinet, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('archive_cabinet_'.$cabinet->getId(), (string) $request->request->get('_token'))) {
            $cabinet->setArchive(true);
            $entityManager->flush();
            $this->addFlash('success', 'Cabinet archive.');
        } else {
            $this->addFlash('error', 'Jeton CSRF invalide.');
        }
    ...
    #[Route('/disponibilites', name: 'app_disponibilite_index', methods: ['GET'])]
    public function disponibiliteIndex(DisponibiliteRepository $disponibiliteRepository): Response
    {
        return $this->render('disponibilite/index.html.twig', [
            ...
            'cabinet_index_route' => 'app_cabinet_index',
            'disponibilite_route_prefix' => 'app_disponibilite_',
        ]);
    }

    #[Route('/disponibilites/new', name: 'app_disponibilite_new', methods: ['GET', 'POST'])]
    public function disponibiliteNew(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('disponibilite/new.html.twig', [
            'form' => $form,
            'index_route' => 'app_disponibilite_index',
        ]);
    }

    #[Route('/disponibilites/{id}/edit', name: 'app_disponibilite_edit', requirements: ['id' => '\d+'], methods: ['GET', 'POST'])]
    ...
    #[Route('/disponibilites/{id}', name: 'app_disponibilite_delete', requirements: ['id' => '\d+'], methods: ['POST'])]
