...
class Disponibilite
{
    ...
    #[Assert\NotNull(message: 'Le cabinet est obligatoire.')]
    ...
    #[Assert\Range(
        min: 1,
        max: 7,
        notInRangeMessage: 'Le jour doit etre compris entre {{ min }} et {{ max }}.'
    )]
    private int $jour = 1;
    ...
    #[Assert\GreaterThan(
        ...
        message: 'L heure de fin doit etre strictement superieure a l heure de debut.'
    )]
