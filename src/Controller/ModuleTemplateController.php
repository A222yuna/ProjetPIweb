...
final class ModuleTemplateController extends AbstractController
{
    ...
    #[IsGranted('ROLE_ADMIN')]
    public function adminCabinets(): Response { return $this->renderModule('admin', 'cabinets'); }
    ...
    #[IsGranted('ROLE_PSYCHOLOGUE')]
    public function psyCabinets(): Response { return $this->renderModule('psychologue', 'cabinets'); }
    ...
    #[IsGranted('ROLE_PATIENT')]
    public function patientCabinets(): Response { return $this->renderModule('patient', 'cabinets'); }
